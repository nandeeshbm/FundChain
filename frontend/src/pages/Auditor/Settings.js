  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>Manage review thresholds and alert behavior using dummy controls.</p>

        <div style={styles.grid}>
          <div style={styles.field}>
            <label style={styles.label}>Risk Threshold</label>
            <select style={styles.input} defaultValue="medium">
          ...
          <div style={styles.field}>
            ...
            <select style={styles.input} defaultValue="72h">
        ...
        <div style={styles.actions}>
          <button style={styles.secondaryBtn} onClick={() => alert("Auditor settings reset (dummy).")}>Reset</button>
          <button style={styles.primaryBtn} onClick={() => alert("Auditor settings saved (dummy).")}>Save Settings</button>
        </div>
      </div>
    </div>
  );
